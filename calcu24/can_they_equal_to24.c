...
// 继续判断下一组：Keep on ? 后输入1
// 结束程序：keep on ? 后输入0
// 输出：true表示能计算出24，并输出表达式; false表示不能计算出24.
...
int main()
{
	printf("Please enter four numbers, with a space between each number:\n");
